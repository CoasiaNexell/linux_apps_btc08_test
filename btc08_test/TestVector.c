...
static BLOCk_DATA_INFO gstGoldenData[6] = {
	// Index 0
	{
		//	Block Header
		{
			...
			0xe2,0x28,0x7a,0x08,
			0x2d,0x0b,0xa6,0xb9,
			0x74,0xcf,0xdd,0x3e,	//	Upper[64] --> SHA256 --> MIDSTATE[32]
			0x49,0x8f,0x76,0xf2,
			//	Merkle Root
			0x22,0x2b,0xe0,0x2d,
			0x62,0x72,0xf0,0x66,
